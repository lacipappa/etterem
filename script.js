...
async function setLang(lang){
  ...
  localStorage.setItem("casabrasa_lang",lang);current=lang;
}
document.querySelectorAll("[data-lang]").forEach(b=>b.addEventListener("click",()=>setLang(b.dataset.lang)));
document.getElementById("reserveForm").addEventListener("submit",e=>{e.preventDefault();alert((cache[current]||{}).form_success||"Demo: a foglalási kérés itt kerülne elküldésre.")});
setLang(current);
